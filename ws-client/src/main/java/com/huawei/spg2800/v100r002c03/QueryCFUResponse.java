...
@XmlRootElement(name = "QueryCFUResponse")
public class QueryCFUResponse
    extends GenericResponseType
{

    @XmlElement(name = "ResultData")
    protected QueryCFUResponse.ResultData resultData;
     ...
     * @return
     *     possible object is
     *     {@link QueryCFUResponse.ResultData }
     *     
     */
    public QueryCFUResponse.ResultData getResultData() {
        return resultData;
    }
     ...
     *     
     */
    public void setResultData(QueryCFUResponse.ResultData value) {
    ...
    public static class ResultData {
        ...
        protected QueryCFUResponse.ResultData.Table1 table1;
         ...
         * @return
         *     possible object is
         *     {@link QueryCFUResponse.ResultData.Table1 }
         *     
         */
        public QueryCFUResponse.ResultData.Table1 getTable1() {
            return table1;
        }
         ...
         *     
         */
        public void setTable1(QueryCFUResponse.ResultData.Table1 value) {
            this.table1 = value;
        }
