 ...
 *         &lt;element name="SIFCSETIDLIST" type="{http://www.huawei.com/SPG2800/V100R002C03}SIFCSETIDListType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "RmvSiFCRequest")
public class RmvSiFCRequest {

    @XmlElement(name = "IMPU")
    protected String impu;
    @XmlElement(name = "PUSI")
    protected String pusi;
    @XmlElement(name = "SIFCSETIDLIST", required = true)
