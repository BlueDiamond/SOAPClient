...
@XmlRootElement(name = "QueryCFBResponse")
public class QueryCFBResponse
    extends GenericResponseType
{

    @XmlElement(name = "ResultData")
    protected QueryCFBResponse.ResultData resultData;
     ...
     * @return
     *     possible object is
     *     {@link QueryCFBResponse.ResultData }
     *     
     */
    public QueryCFBResponse.ResultData getResultData() {
        return resultData;
    }
     ...
     *     
     */
    public void setResultData(QueryCFBResponse.ResultData value) {
    ...
    public static class ResultData {
        ...
        protected QueryCFBResponse.ResultData.Table1 table1;
         ...
         * @return
         *     possible object is
         *     {@link QueryCFBResponse.ResultData.Table1 }
         *     
         */
        public QueryCFBResponse.ResultData.Table1 getTable1() {
            return table1;
        }
         ...
         *     
         */
        public void setTable1(QueryCFBResponse.ResultData.Table1 value) {
            this.table1 = value;
        }
